...
var Interview = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma.interview.update({
                                where: { id: this.id },
                                data: interviewData,
                            })];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: return [4 /*yield*/, prisma.interview.create({
                            data: interviewData,
                        })];
    ...
    Interview.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.interview.findUnique({
                            where: { id: id },
                        })];
                    case 1:
                        data = _a.sent();
                        ...
                        return [2 /*return*/, new Interview(data)];
                }
            });
        });
    };
