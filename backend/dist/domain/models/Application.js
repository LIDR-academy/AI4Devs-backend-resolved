...
var Application = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2: return [4 /*yield*/, prisma.application.create({
                            data: applicationData,
                        })];
    ...
    Application.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.application.findUnique({
                            where: { id: id },
                        })];
                    case 1:
                        data = _a.sent();
                        ...
                        return [2 /*return*/, new Application(data)];
                }
            });
        });
    };
